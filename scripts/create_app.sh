...
APP_NAME="Vocal Separator"
APP_DIR="$APP_NAME.app"
CONTENTS_DIR="$APP_DIR/Contents"
MACOS_DIR="$CONTENTS_DIR/MacOS"
RESOURCES_DIR="$CONTENTS_DIR/Resources"

# Clean up existing (quote for app name with space)
rm -rf "$APP_DIR"
...
echo "   (Dev .app is generated by this script and can be removed anytime; run the script again to recreate.)"
echo ""
echo "To use:"
